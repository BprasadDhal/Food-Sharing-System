...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"Keonjhar\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $keonjhr=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"Bhubaneswar\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $bhubaneswar=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"Cuttack\"";
...
var xplace=["Keonjhar","Bhubaneswar","Cuttack"];
var yplace=[<?php echo json_encode($keonjhr,JSON_HEX_TAG);?>,<?php echo json_encode($bhubaneswar,JSON_HEX_TAG);?>,<?php echo json_encode($cuttack,JSON_HEX_TAG);?>];
