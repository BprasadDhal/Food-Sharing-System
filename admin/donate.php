...
<body>
    ...
    <section class="dashboard">
        ...
        <br>
         ...
         if (isset($_POST['food']) && isset($_POST['delivery_person_id'])) {
            ...
            $sql_update = "UPDATE food_donations SET received_by = $delivery_person_id WHERE Fid = $order_id";
    ...
    if(isset($_POST['location'])) {
      ...
      $sql = "SELECT * FROM food_donations WHERE location='$location' AND assigned_to IS NOT NULL";
