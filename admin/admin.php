...
// Define the SQL query to fetch unassigned orders
$sql_receive = "SELECT * FROM receive_food WHERE assigned_to IS NULL and location=\"$loc\"";
...
if (isset($_POST['food_receive']) && isset($_POST['delivery_person_id_receive'])) {
    ...
    $sql_receive = "SELECT * FROM receive_food WHERE rid = $order_id AND assigned_to IS NOT NULL";
    $result_receive = mysqli_query($connection, $sql_receive);
    ...
    $sql_receive = "UPDATE receive_food SET assigned_to = $delivery_person_id WHERE rid = $order_id";
    // $result = mysqli_query($conn, $sql);
    $result_receive=mysqli_query($connection, $sql_receive);
...
<div class="table-container">
       ...
       <tbody>
        ...
        <?php    echo "<tr><td data-label=\"name\">".$row_receive['name']."</td><td data-label=\"food\">".$row_receive['food']."</td><td data-label=\"category\">".$row_receive['category']."</td><td data-label=\"phoneno\">".$row_receive['phoneno']."</td><td data-label=\"date\">".$row_receive['date']."</td><td data-label=\"Address\">".$row_receive['adress']."</td><td data-label=\"quantity\">".$row_receive['quantity']."</td>";
?> 
